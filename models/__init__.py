...
from models.TSViT.TSViTcls_noclasstoken import TSViTcls as TSViTcls_noclasstoken
...
def get_model(config, device):
    ...
    if model_config['architecture'] == "TSViTcls_noclasstoken":
        model_config['device'] = device
        return TSViTcls_noclasstoken(model_config).to(device)
